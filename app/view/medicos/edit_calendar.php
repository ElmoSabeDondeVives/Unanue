                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-2">
                                    <div class="form-check">
                                        <input type="checkbox" <?= ($data->lunes ==1)?'checked':''; ?> id="lunes" class="form-check-input" >
                                        <label for="lunes" class="form-check-label">LUNES</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" id="martes"  <?= ($data->martes ==1)?'checked':''; ?> class="form-check-input" >
                                        <label for="martes" class="form-check-label">MARTES</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" id="miercoles"  <?= ($data->miercoles ==1)?'checked':''; ?> class="form-check-input" >
                                        <label for="miercoles" class="form-check-label">MIERCOLES</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" id="jueves"  <?= ($data->jueves ==1)?'checked':''; ?> class="form-check-input" >
                                        <label for="jueves" class="form-check-label">JUEVES</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" id="viernes"  <?= ($data->viernes ==1)?'checked':''; ?> class="form-check-input" >
                                        <label for="viernes" class="form-check-label">VIERNES</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" id="sabado"  <?= ($data->sabado ==1)?'checked':''; ?> class="form-check-input" >
                                        <label for="sabado" class="form-check-label">SABADO</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" id="domingo"  <?= ($data->domingo ==1)?'checked':''; ?> class="form-check-input" >
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="time" id="hora_inicio" value="<?= date('H:i',strtotime($data->hora_inicio)) ?>" class="form-control">
                                        </div>
                                        <div class="col-lg-6">
                                            <label for="hora_fin">Hora de Termino</label>
                                            <input type="time" id="hora_fin" value="<?= date('H:i',strtotime($data->hora_fin)) ?>" class="form-control">
                                        </div>
                                        <div class="col-lg-6">
                                            <label for="intervalo" >Intervalo (Minutos)</label>
                                            <input type="number" class="form-control"  value="<?= $data->intervalo  ?>" id="intervalo">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 text-center">
                                    <button class="btn btn-lg btn-success" id="btn-save-data" onclick="save_calendar_edit()" ><i class="bx bx-list-ul"></i> GUARDAR INFORMACIÒN </button>
                                </div>
