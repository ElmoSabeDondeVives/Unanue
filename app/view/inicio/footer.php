                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget-area">
                        <div class="footer-logo">
                            <img src="<?=_SERVER_ ?>styles/ft/img/core-img/logo.png" alt="">
                        </div>
                        ...
                        <div class="footer-social-info">
                            ...
                            <a href="<?= _SERVER_.'Login' ?>"><i class="fa fa-home" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="widget-blog-post">
                            ...
                            <div class="widget-single-blog-post d-flex">
                                <div class="widget-post-thumbnail">
                                    <img src="<?=_SERVER_ ?>styles/ft/img/blog-img/ln1.jpg" alt="">
                                </div>
                            ...
                            <div class="widget-single-blog-post d-flex">
                                <div class="widget-post-thumbnail">
                                    <img src="<?=_SERVER_ ?>styles/ft/img/blog-img/ln2.jpg" alt="">
                                </div>
                                <div class="widget-post-content">
                            ...
                            <div class="widget-single-blog-post d-flex">
                                <div class="widget-post-thumbnail">
                                    <img src="<?=_SERVER_ ?>styles/ft/img/blog-img/ln3.jpg" alt="">
                                </div>
                                <div class="widget-post-content">
...
<script src="<?=_SERVER_ ?>styles/ft/js/jquery/jquery-2.2.4.min.js"></script>
<!-- Popper js -->
<script src="<?=_SERVER_ ?>styles/ft/js/popper.min.js"></script>
<!-- Bootstrap js -->
<script src="<?=_SERVER_ ?>styles/ft/js/bootstrap.min.js"></script>
<!-- Plugins js -->
<script src="<?=_SERVER_ ?>styles/ft/js/plugins.js"></script>
<!-- Active js -->
<script src="<?=_SERVER_ ?>styles/ft/js/active.js"></script>
