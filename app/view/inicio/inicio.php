    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img bg-overlay-white" style="background-image: url(<?=_SERVER_ ?>styles/ft/img/bg-img/hero1.jpg);">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img bg-overlay-white" style="background-image: url(<?=_SERVER_ ?>styles/ft/img/bg-img/breadcumb3.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img bg-overlay-white" style="background-image: url(<?=_SERVER_ ?>styles/ft/img/bg-img/breadcumb1.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="medilife-contact-info">
                                    ...
                                    <div class="single-contact-info mb-30">
                                        <img src="<?=_SERVER_ ?>styles/ft/img/icons/alarm-clock.png" alt="">
                                        <p>Mon - Sat 08:00 - 21:00 <br>Sunday CLOSED</p>
                                    </div>
                                    <!-- Single Contact Info -->
                                    <div class="single-contact-info mb-30">
                                        <img src="<?=_SERVER_ ?>styles/ft/img/icons/envelope.png" alt="">
                                        <p>0080 673 729 766 <br>contact@business.com</p>
                                    </div>
                                    <!-- Single Contact Info -->
                                    <div class="single-contact-info">
                                        <img src="<?=_SERVER_ ?>styles/ft/img/icons/map-pin.png" alt="">
    ...
    <div class="medilife-gallery-area owl-carousel">
        ...
        <div class="single-gallery-item">
            <img src="<?=_SERVER_ ?>styles/ft/img/bg-img/g1.jpg" alt="">
            <div class="view-more-btn">
                <a href="<?=_SERVER_ ?>styles/ft/img/bg-img/g1.jpg" class="btn gallery-img">See More +</a>
            </div>
        </div>
        <!-- Single Gallery Item -->
        <div class="single-gallery-item">
            <img src="<?=_SERVER_ ?>styles/ft/img/bg-img/g2.jpg" alt="">
            <div class="view-more-btn">
                <a href="<?=_SERVER_ ?>styles/ft/img/bg-img/g2.jpg" class="btn gallery-img">See More +</a>
            </div>
        </div>
        <!-- Single Gallery Item -->
        <div class="single-gallery-item">
            <img src="<?=_SERVER_ ?>styles/ft/img/bg-img/g3.jpg" alt="">
            <div class="view-more-btn">
                <a href="<?=_SERVER_ ?>styles/ft/img/bg-img/g3.jpg" class="btn gallery-img">See More +</a>
            </div>
        </div>

        <!-- Single Gallery Item -->
        <div class="single-gallery-item">
            <img src="<?=_SERVER_ ?>styles/ft/img/bg-img/g4.jpg" alt="">
            <div class="view-more-btn">
                <a href="<?=_SERVER_ ?>styles/ft/img/bg-img/g4.jpg" class="btn gallery-img">See More +</a>
            </div>
        </div>
    </div>
    <!-- ***** Gallery Area End ***** -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="features-thumbnail">
                        <img src="<?=_SERVER_ ?>styles/ft/img/bg-img/medical1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-area mb-100">
                        ...
                        <div class="blog-post-thumbnail">
                            <img src="<?=_SERVER_ ?>styles/ft/img/blog-img/1.jpg" alt="">
                            <!-- Post Date -->
                            <div class="post-date">
                        ...
                        <div class="post-content">
                            <div class="post-author">
                                <a href="#"><img src="<?=_SERVER_ ?>styles/ft/img/blog-img/p1.jpg" alt=""></a>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-area mb-100">
                        <!-- Post Thumbnail -->
                        <div class="blog-post-thumbnail">
                            <img src="<?=_SERVER_ ?>styles/ft/img/blog-img/2.jpg" alt="">
                            <!-- Post Date -->
                            <div class="post-date">
                                <a href="#">Jan 23, 2018</a>
                            </div>
                        ...
                        <div class="post-content">
                            <div class="post-author">
                                <a href="#"><img src="<?=_SERVER_ ?>styles/ft/img/blog-img/p2.jpg" alt=""></a>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-area mb-100">
                        <!-- Post Thumbnail -->
                        <div class="blog-post-thumbnail">
                            <img src="<?=_SERVER_ ?>styles/ft/img/blog-img/3.jpg" alt="">
                            <!-- Post Date -->
                            <div class="post-date">
                                <a href="#">Jan 23, 2018</a>
                            </div>
                        ...
                        <div class="post-content">
                            <div class="post-author">
                                <a href="#"><img src="<?=_SERVER_ ?>styles/ft/img/blog-img/p3.jpg" alt=""></a>
                            </div>
