...
-- Tiempo de generación: 23-07-2023 a las 18:50:41
...
CREATE TABLE `especialidades` (
  ...
  `nombre_especialidad` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `estado_especialidad` tinyint(2) DEFAULT NULL,
...
INSERT INTO `especialidades` (`id_especialidad`, `nombre_especialidad`, `estado_especialidad`, `fecha_creacion`) VALUES
(1, 'CASA', 0, '2023-07-23 00:38:56'),
(2, 'ADMINISTRACION', 0, '2023-07-23 00:46:15'),
(3, 'MEDICINA GENERAL', 0, '2023-07-23 10:53:14');
...
(9, 'Logistica', 'Logistica', 'bx bx-cog', 4, 1, 1),
(10, 'Inicio', 'Inicio', 'bx bx-home', 5, 0, 1);
...
(21, 9, 'Servicios', 'config', '', 1, 1, 1),
(22, 9, 'Especialidades', 'especialidades', '', 1, 2, 1),
(23, 10, 'inicio', 'inicio', '', 1, 0, 1);
...
(20, 21, 'save_service', 1),
(21, 21, 'save_edit_service', 1),
(22, 22, 'save_espe', 1),
(23, 22, 'save_edit_espe', 1);
...
CREATE TABLE `servicios` (
  ...
  `nombre_servicio` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `estado_servicio` tinyint(2) DEFAULT NULL,
  `fecha_crecion` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `servicios` (`id_servicio`, `nombre_servicio`, `estado_servicio`, `fecha_crecion`) VALUES
(1, 'MEDICINA ', 1, '2023-07-22 23:13:17'),
(2, 'SANIDAD', 0, '2023-07-22 23:15:02');
...
(1, 1, 2, 'superadmin', '$2y$10$oPOOOgTUr4zIh511ATm/q.vzsAmxP.e2.vzyEbRn/1pzyWz2oXj0a', 'cesarjose@bufeotec.com', 'media/usuarios/usuario.jpg', 1, '2020-09-17 00:00:00', '2023-07-23 10:41:32', '2020-09-17 00:00:00'),
